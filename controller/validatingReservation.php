...
if (array_key_exists($sResDate, $_POST) && preg_match($dDateRegex, $_POST[$sResDate])
    ...
    echo 'Un problème est survenu, veuillez revenir en arrière et corriger le formulaire.<br>
    <a href="index.php?controller=home&action=Commander">Retour en arrière</a>';
}